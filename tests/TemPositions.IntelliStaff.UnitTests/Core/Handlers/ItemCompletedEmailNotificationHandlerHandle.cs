...
using TemPositions.IntelliStaff.Core.ProjectAggregate.Events;
using TemPositions.IntelliStaff.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace TemPositions.IntelliStaff.UnitTests.Core.Handlers;
